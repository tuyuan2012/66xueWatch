//
//  CircleListInterfaceController.m
//  66xueWatchDemo
//
...
#import "CircleListInterfaceController.h"
#import "CircleRowIconAndUserName.h"
#import "CircleRowContent.h"
#import "CircleRow.h"
...
@interface CircleListInterfaceController ()
...
@implementation CircleListInterfaceController
...
-(void)reloadData
{
    ...
    for (int i = 0; i<self.weiboArray.count*2; i ++) {
        if (i%2 == 0) {
            ...
            [self.table insertRowsAtIndexes:[NSIndexSet indexSetWithIndex:i] withRowType:@"CircleRowIconAndUserName"];
            CircleRowIconAndUserName *iconAndUserNameC = [self.table rowControllerAtIndex:i];
        ...
        if (i%2 ==1) {
            ...
            LYRWeibo*weibo = self.weiboArray[index];
            [self.table insertRowsAtIndexes:[NSIndexSet indexSetWithIndex:i] withRowType:@"CircleRowContent"];
            CircleRowContent *contentC = [self.table rowControllerAtIndex:i];
